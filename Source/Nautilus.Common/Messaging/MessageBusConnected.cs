...
namespace Nautilus.Common.Messaging
{
  ...
  public abstract class MessageBusConnected : MessagingComponent
  {
    ...
    protected MessageBusConnected(IComponentryContainer container, IMessageBusAdapter messagingAdapter) : base(container)
    {
    ...
    protected void Subscribe<T>() where T : Message
    {
    ...
    protected void Send<T>(T message, Address receiver) where T : Message
    {
    ...
    /// <typeparam name="T">The message type.</typeparam>
    protected void Send<T>(T message, List<Address> receivers) where T : Message
    {
    ...
    protected void SendToBus<T>(T message) where T : Message
    {
